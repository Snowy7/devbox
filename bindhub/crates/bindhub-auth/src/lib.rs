...
const ENVELOPE_MAGIC: &[u8] = b"bindhub-key-envelope-v1\n";
const COMPLETION_ENVELOPE_MAGIC: &[u8] = b"bindhub-pairing-completion-v1\n";
const TOKEN_PREFIX: &str = "bindhub-pair-v1";
const JOIN_PREFIX: &str = "bindhub-join-v1";
const COMPLETION_PREFIX: &str = "bindhub-complete-v1";
...
impl PairingInvitationToken {
    ...
    fn completion_key_hex(&self) -> AuthResult<String> {
        ...
        let key = blake3::derive_key("bindhub pairing completion key v1", &material);
        Ok(hex_encode(&key))
    }
}
