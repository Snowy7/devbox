...
use bindhub_store::{BlobCache, BlobCacheError, ManifestEntryRecord, PersistedSnapshot};
...
fn temp_file_name() -> String {
    ...
    format!(".bindhub-restore-{}-{nanos}-{counter}.tmp", process::id())
}
...
mod tests {
    ...
    use bindhub_store::{BlobCache, ProjectRecord, SnapshotRecord};
